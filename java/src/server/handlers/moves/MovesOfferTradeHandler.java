...
public class MovesOfferTradeHandler extends IHandler{

	@Override
	public void handle(HttpExchange exchange) throws IOException {
		// TODO Auto-generated method stub
		OfferTrade trade = Converter.fromJson(exchange.getRequestBody(), OfferTrade.class);
		...
		try {			
			...
			OfferTradeCommand command = new OfferTradeCommand(cookieGame, trade);
			command.execute();
