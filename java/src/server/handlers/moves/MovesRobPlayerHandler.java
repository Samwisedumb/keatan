...
public class MovesRobPlayerHandler extends IHandler {

	@Override
	public void handle(HttpExchange exchange) throws IOException {
		// TODO Auto-generated method stub
		RobPlayer rob = Converter.fromJson(exchange.getRequestBody(), RobPlayer.class);
		...
		try {			
			...
			RobPlayerCommand command = new RobPlayerCommand(cookieGame, rob);
			command.execute();
