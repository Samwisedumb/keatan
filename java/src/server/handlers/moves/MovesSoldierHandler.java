...
public class MovesSoldierHandler extends IHandler {

	@Override
	public void handle(HttpExchange exchange) throws IOException {
		// TODO Auto-generated method stub
		Soldier soldier = Converter.fromJson(exchange.getRequestBody(), Soldier.class);
		...
		try {			
			...
			SoldierCommand command = new SoldierCommand(cookieGame, soldier);
			command.execute();
